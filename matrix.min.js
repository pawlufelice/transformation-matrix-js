...
var Matrix = (function () {
	function Matrix() {
		...
		if (arguments) {
			['a', 'b', 'c', 'd', 'e', 'f'].forEach(function (attr, i) {
				if (typeof _arguments[i] !== 'undefined') _this[attr] = _arguments[i];
			});
		}
	}
  ...
  */
   ...
   */
		...
		key: 'reflectVector',
		value: function reflectVector(_ref) {
			var x = _ref.x;
			var y = _ref.y;
   ...
   */
		...
		value: function rotateFromVector(_ref2) {
			var x = _ref2.x;
			var y = _ref2.y;
   ...
   */
		...
		key: 'interpolate',
		value: function interpolate(m2, t, context) {
   ...
   */
		...
		key: 'interpolateAnim',
		value: function interpolateAnim(m2, t, context) {
   ...
   */
		...
		key: 'decompose',
		value: function decompose(useLU) {
   ...
   */
		...
		key: 'applyToPoint',
		value: function applyToPoint(_ref3) {
			var x = _ref3.x;
			var y = _ref3.y;
   ...
   */
		...
		key: 'applyToArray',
		value: function applyToArray(points) {
   ...
   */
		...
		value: function applyToTypedArray(points, use64) {
			...
			while (i < l) {
				var _applyToPoint = this.applyToPoint({ x: points[i], y: points[i + 1] });

				var x = _applyToPoint.x;
				var y = _applyToPoint.y;
   ...
   */
		...
		key: 'clone',
		value: function clone(noContext) {
			var me = this,
			    m = new Matrix();
			m.a = me.a;
			m.b = me.b;
